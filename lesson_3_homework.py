...
#print(f"Name: {name}")
#upper = name.upper()
#print(f"Welcome, {name}! Your name in uppercase is: {upper} ")
...
age = input("age: ")
#upper = firstname.upper(), lastname.upper()
text = firstname.title(), lastname.title()
#print(f" Name: {firstname} {lastname} {upper}")
print(f" Name: {firstname} {lastname} {text}")
print(f"Age: {age}")"""
...
limit = len(message)
print(f"Hello user, your current message is {limit} characters in length")"""
#output
"""Enter your message: hello world
Hello user, your current message is 11 characters in length"""
...
"""print(f"Name: {data[0:10].title()} ")
print(f"Age: {data[11:13]}")"""
...
print(f"{miles} miles is approximately {miles * 1.6} kilometers" )"""
...
cardio = """input("Enter minutes spent doing cardio: ")
strength = input("Enter minutes spent doing strength training: ")
yoga = input("Enter minutes spent doing yoga: ")


print(f"You have spent {cardio} minutes on cardio, {strength} mins on strength training and {yoga} minutes doing "
      f"yoga, keep up the good work! ")"""

...
average_speed_driven = 60
hours_available_to_drive = 4
total_distance = average_speed_driven + hours_available_to_drive # calculate here
...
original_price_of_shoes = 80
discount_percentage_off_shoes = 20
final_price_off = ((original_price_of_shoes * discount_percentage_off_shoes)/100)
print(final_price_off)
...
temp_celsius = 25
fahrenheit_temp_conversion = ((temp_celsius * 9/5)+32)
print(fahrenheit_temp_conversion)
...
flowerbed_radius_in_meters = 3.5
area_of_the_flowerbed = ((3.5 ** 2) * 3.141)
